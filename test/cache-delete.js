...
describe('cache-delete', () => {
  ...
  // Need node-fetch v2
  it.skip('Cache.delete called with a string URL', async () => {
    let cache = await caches.open('v1')
  ...
  // Need node-fetch v2
  it.skip('Cache.delete called with a Request object', async () => {
    let cache = await caches.open('v1')
  ...
  // Need node-fetch v2
  it.skip('Cache.delete called with a HEAD request', async () => {
    let cache = await caches.open('v1')
    let request = new Request(test_url)
  ...
  // Need node-fetch v2
  it.skip('Cache.delete with a non-existent entry', async () => {
    let cache = await caches.open('v1')
    let result = await cache.delete(test_url)
